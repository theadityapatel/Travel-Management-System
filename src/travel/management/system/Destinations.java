...
public class Destinations extends JFrame implements Runnable {
    ...
    public void run() {
        String[] text = new String[] {"JW Marriot Hotel"," Madrin Oriental Hotel","Raddison Blue Hotel","Classico Hotel","The Bay Club hotel","The Taj Hotel","River View Hotel","Breeze Blue Hotel"};
        try {
            for (int i = 0; i<=9;i++) {
